...
<div>
  <div className="box boxwidebottom card">
    ...
    <h2>Learn More</h2>
    <p>For more information about writing that conveys respect to all people and promotes equal opportunities,
    see the [Guidelines for Inclusive Language](http://www.linguisticsociety.org/content/guidelines-inclusive-language "Guidelines for inclusive language") from the Linguistic Society of America.<br/></p>
    </div>
  </div>
</div>
